/********************************** (C) COPYRIGHT
 ******************************** File Name          : usb_host_config.h Author
 *: WCH Version            : V1.0.0 Date               : 2022/08/29 Description
 *:
 *********************************************************************************
...
#define DEF_RE_ATTACH_TIMEOUT                                                  \
  100 // Wait for the USB device to reconnect after reset, 100mS timeout
#define DEF_WAIT_USB_TRANSFER_CNT 1000 // Wait for the USB transfer to complete
#define DEF_CTRL_TRANS_TIMEOVER_CNT                                            \
  200000 / 20 // Control transmission delay timing
